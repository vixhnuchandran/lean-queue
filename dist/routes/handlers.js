...
exports.checkQueue =
  ...
  exports.queuesDetails =
  exports.recentQueues =
  exports.taskStats =
  exports.deleteAll =
  exports.deleteQueue =
  exports.status =
  exports.completedResults =
  exports.getResults =
  exports.submitResults =
  exports.nextAvailableTask =
  exports.addTasks =
  exports.createQueue =
    void 0
...
const createQueue = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const requestId = req.requestId
    logger_1.console.log({
    ...
    try {
      ...
      if (!req.queryManager) {
        throw new error_1.QueueError(
          "QueryManager is not defined",
          error_1.QueueErrorCode.QUEUE_NOT_EXIST
        )
      }
      ...
      if (!type)
        throw new error_1.ValidationError(
          "type is required",
          error_1.ValidationErrorCode.MISSING_PROPERTY
        )
      ...
      if (options) (0, validations_1.validateOptions)(options)
    } catch (err) {
    ...
    try {
      ...
      const result = yield req.queryManager.createQueueAndAddTasks(
        type,
        tasks,
        tags,
        options,
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (!queue)
        throw new error_1.ValidationError(
          "queue is required",
          error_1.ValidationErrorCode.MISSING_QUEUE_ID
        )
      yield (0, validations_1.validateQueueId)(queue, req.queryManager)
      if (!tasks)
        throw new error_1.ValidationError(
          "tasks are required",
          error_1.ValidationErrorCode.EMPTY_TASKS
        )
      ;(0, validations_1.validateTasks)(tasks)
    } catch (err) {
      return next(err.stack)
    ...
    try {
      ...
      logger_1.console.error({ message: `add-tasks-error: ${err.message}` })
      return next(err)
    }
  })
exports.addTasks = addTasks
const nextAvailableTask = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const requestId = req.requestId
    logger_1.console.log({
    ...
    try {
      ...
      if (!queue && !type && !tags)
        throw new error_1.ValidationError(
          ...
          error_1.ValidationErrorCode.EMPTY_REQUEST_BODY
        )
      if (queue)
        yield (0, validations_1.validateQueueId)(queue, req.queryManager)
      if (type) (0, validations_1.validateQueueType)(type)
    } catch (err) {
    ...
    try {
      const { queue, type, tags } = requestBody
      if (queue)
        nextAvailableTask = yield req.queryManager.getNextAvailableTaskByQueue(
          queue
        )
      else if (type)
        nextAvailableTask = yield req.queryManager.getNextAvailableTaskByType(
          type
        )
      else if (tags)
        nextAvailableTask = yield req.queryManager.getNextAvailableTaskByTags(
          tags
        )
...
const completedResults = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const requestId = req.requestId
    logger_1.console.log({
    ...
    try {
      ...
      yield (0,
      validations_1.validateQueueId)(parseInt(queue.toString(), 10), req.queryManager)
    ...
    try {
      ...
      const responsePromise = new Promise((resolve, reject) =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          try {
            const areAllTasksCompleted = yield (_a = req.queryManager) ===
              null || _a === void 0
              ? void 0
              : _a.areAllTasksCompleted(Number(queue))
            if (areAllTasksCompleted !== undefined) {
              if (areAllTasksCompleted) {
                const results = yield (_b = req.queryManager) === null ||
                _b === void 0
                  ? void 0
                  : _b.getResults(queue)
...
const submitResults = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const requestId = req.requestId
    logger_1.console.log({
    ...
    try {
      ...
      if (resultData) {
        ...
        if (yield req.queryManager.areAllTasksCompleted(queue)) {
          logger_1.console.log("All Tasks Finished")
...
const getResults = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      queue = req.params.queue
      yield (0,
      validations_1.validateQueueId)(parseInt(queue), req.queryManager)
    } catch (err) {
      return next(err)
    }
    try {
...
const status = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const requestId = req.requestId
    logger_1.console.log({
      message: `Incoming client request for 'status'`,
      requestId,
    })
    let queue
    try {
    ...
    try {
      const { total_jobs, completed_count, error_count } =
        yield req.queryManager.getStatus(parseInt(queue, 10))
      return res.status(http_status_codes_1.StatusCodes.OK).json({
...
const deleteQueue = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const requestId = req.requestId
    logger_1.console.log({
...
const deleteAll = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      yield (_c = req.queryManager) === null || _c === void 0
        ? void 0
        : _c.deleteEverything()
      return res.sendStatus(http_status_codes_1.StatusCodes.OK)
    } catch (err) {
...
const taskStats = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const result = yield (_d = req.queryManager) === null || _d === void 0
        ? void 0
        : _d.getTasksStats(String(timeInterval))
...
const recentQueues = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _e
    try {
      if (!req.queryManager) {
      ...
      const result = yield (_e = req.queryManager) === null || _e === void 0
        ? void 0
        : _e.getRecentQueues()
      return res.status(http_status_codes_1.StatusCodes.OK).json(result)
    } catch (err) {
...
const queuesDetails = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _f
    try {
      if (!req.queryManager) {
      ...
      const result = yield (_f = req.queryManager) === null || _f === void 0
        ? void 0
        : _f.allQueueDetails(req.query)
      return res.status(http_status_codes_1.StatusCodes.OK).json(result)
    } catch (err) {
      return next(err)
    }
...
const queueDetails = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _g
    ...
    try {
      ...
      const result = yield (_g = req.queryManager) === null || _g === void 0
        ? void 0
        : _g.getQueueDetails(queue, req.query)
      return res.status(http_status_codes_1.StatusCodes.OK).json(result)
    } catch (err) {
      return next(err)
    }
...
const queueCounts = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _h
    try {
      if (!req.queryManager) {
      ...
      const result = yield (_h = req.queryManager) === null || _h === void 0
        ? void 0
        : _h.queueAndTasksCounts()
      return res.status(http_status_codes_1.StatusCodes.OK).json(result)
    } catch (err) {
      return next(err)
    }
...
const taskDetails = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const result = yield (_j = req.queryManager) === null || _j === void 0
        ? void 0
        : _j.TasksDetailsOfQueues(queues)
      return res.status(http_status_codes_1.StatusCodes.OK).json(result)
    } catch (err) {
      return next(err)
    }
